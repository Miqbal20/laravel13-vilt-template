<template>
    ...
    <AppLayout>
        ...
        <!-- Welcome banner -->
        <div
            class="relative bg-gradient-to-br from-[#0f2044] to-[#1e3a7b] rounded-2xl p-9 flex items-center justify-between mb-7 overflow-hidden">
            <div class="absolute w-[250px] h-[250px] rounded-full pointer-events-none"
                style="background:rgba(56,189,248,.15); top:-80px; right:100px"></div>
            <div class="absolute w-[180px] h-[180px] rounded-full pointer-events-none"
                style="background:rgba(37,99,235,.2); bottom:-60px; right:-40px"></div>
            <div class="relative z-10">
                ...
                <p class="text-white/65 text-sm leading-relaxed max-w-[420px]">
                    This is your Admin dashboard. All components are modular and ready to use. Creaed by Miqbal20
                </p>
            </div>
            <div
                class="relative z-10 flex-shrink-0 bg-white/10 backdrop-blur-sm border border-white/15 rounded-xl px-6 py-4 text-center">
        ...
        <div class="grid grid-cols-3 gap-4 mb-7">
            <div v-for="stat in stats" :key="stat.label"
                ...
                <div>
                    ...
                    <div class="font-sora text-[26px] font-bold text-[#0f2044] leading-none my-0.5">{{ stat.value }}
                    </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-[14px] p-6 border-[1.5px] border-slate-200">
                <h4 class="font-sora text-[15px] font-semibold text-[#0f2044] mb-3.5 flex items-center gap-2">
                    <svg class="text-blue-600 w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2">
                ...
                <div v-for="item in activity" :key="item.text"
                    class="flex items-center gap-3 py-2.5 border-b border-slate-200 last:border-b-0">
            ...
            <div class="bg-white rounded-[14px] p-6 border-[1.5px] border-slate-200">
                ...
                <div
                    class="bg-blue-50 border-[1.5px] border-blue-200 rounded-[10px] px-4 py-3 text-[13.5px] text-blue-700 flex items-start gap-2.5 mb-2.5">
